...
写给创始人和小型 B2B 团队的实用手册：找到客户，讲清产品，帮助客户把事情做好。

**[在 Mintlify 阅读完整内容](https://b2-b-playbook.mintlify.app)** · [English](README.md) · [浏览全部指南](playbooks/)

**最后核验：** 2026-09-06 · **阅读编辑：** 2026-09-12

你可能正在写第一封外联邮件、准备客户沟通，或复盘一次效果不好的营销活动。从眼前的问题开始，读一个例子，复制一份能用的工作表，再按自己的情况调整。不必从头读完。

**内容可免费阅读。** 工作文件可按[使用说明](LICENSE)复制给团队私下使用。

## 先解决手头的问题

想直接完成一件事，可以从[三条实操路线](playbooks/start-here.md)开始：找到首批客户、准备一次外联测试、规划展会跟进。每条路线都包含指南、模板、填写示例和完成标准。
...
我是 Ivan Xu，Lensmor 的创始人。我维护这份手册，希望让创始人和 B2B 团队在做具体工作时，多一个能看懂、用得上、也可以提出不同看法的参考。
...
- 内容会根据实际使用中的问题持续修订；指南是起点，你可以按自己的团队和客户情况调整。
- 仓库公开可读，但目前不采用开源许可证；复制和转载范围以使用说明为准。

**当前覆盖：** 131 篇已发布 Playbook · 56 份工作文件 · 43 个精选工具 · 20 个阅读源 · 9 个领域指南

你可以复制模板，私下用于自己的工作。转载内容需要获得许可，详见[版权与使用说明](LICENSE)。

如果某一页对你有帮助，欢迎 **Star 收藏**，也可以把那一页分享给正在解决类似问题的人。

如果某一步不清楚，或例子与你的工作相差太远，欢迎[告诉我在哪里卡住](https://github.com/weilun88313/B2B-Playbook/issues/new?template=reader-feedback.yml)。请不要附上客户个人信息或保密数据。
