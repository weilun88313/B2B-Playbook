...
|---|---|---|---|
| [Demo scorecard](https://github.com/weilun88313/B2B-Playbook/blob/main/templates/demo-scorecard.xlsx) | Sheet | Score a demo on what happened, not how it felt | [Demo](playbooks/02-product-marketing/demo.md) |
| [Lead-scoring ledger](https://github.com/weilun88313/B2B-Playbook/blob/main/templates/lead-scoring-ledger.xlsx) | Sheet | Write fit, intent, negative rules, and thresholds before the MAP | [Lead scoring](playbooks/09-operations-pipeline-and-measurement/lead-scoring.md) |
| [Demand plan](https://github.com/weilun88313/B2B-Playbook/blob/main/templates/gtm-demand-plan.xlsx) | Sheet | Turn channel volume and conversion into pipeline math | [GTM planning](playbooks/09-operations-pipeline-and-measurement/gtm-planning.md) |
| [Sales capacity](https://github.com/weilun88313/B2B-Playbook/blob/main/templates/gtm-sales-capacity.xlsx) | Sheet | Turn heads, quota, ramp, and cycle into a closeable number | [GTM planning](playbooks/09-operations-pipeline-and-measurement/gtm-planning.md) |
| [CRM field map](https://github.com/weilun88313/B2B-Playbook/blob/main/templates/crm-field-map.xlsx) | Sheet | Map legacy fields to the new org and kill empty customs | [CRM data model](playbooks/09-operations-pipeline-and-measurement/crm-data-model.md) |
| [Vendor evaluation](https://github.com/weilun88313/B2B-Playbook/blob/main/templates/vendor-evaluation.xlsx) | Sheet | Split jobs, test win reasons and gaps, refuse a borrowed 9.2/10 | [MarTech governance](playbooks/09-operations-pipeline-and-measurement/martech-governance.md) |
| [Sales cadence](https://github.com/weilun88313/B2B-Playbook/blob/main/templates/sales-cadence.xlsx) | Sheet | Put pipe-gen, forecast, and coaching on different clocks | [Sales operating cadence](playbooks/09-operations-pipeline-and-measurement/sales-operating-cadence.md) |
| [Incentive timing](https://github.com/weilun88313/B2B-Playbook/blob/main/templates/incentive-timing.xlsx) | Sheet | Write clawback/holdback and time-box draws as exceptions | [Incentive timing](playbooks/09-operations-pipeline-and-measurement/incentive-timing.md) |
| [GTM experiment ledger](https://github.com/weilun88313/B2B-Playbook/blob/main/templates/gtm-experiment-ledger.xlsx) | Sheet | One hypothesis per row, with a decision the result may change | [Experimentation](playbooks/09-operations-pipeline-and-measurement/experimentation.md) |
| [Answer visibility](https://github.com/weilun88313/B2B-Playbook/blob/main/templates/answer-visibility.xlsx) | Sheet | Prompt-test buyer questions; clicks are partial under zero-click | [SEO and AEO](playbooks/04-channels-and-distribution/seo-and-aeo.md) |
| [AI teammate brief](templates/ai-teammate-brief.md) | Doc | Write the job, guardrails, and steps before a custom GPT/Gem/Project | [Content strategy](playbooks/03-brand-story-and-content/content-strategy.md) |
...
| [CS workspace](https://github.com/weilun88313/B2B-Playbook/blob/main/templates/cs-workspace.xlsx) | Sheet | Map post-sale fields to realization, relationship, renewal, or risk | [CS workspace](playbooks/08-lifecycle-and-customer-marketing/cs-workspace.md) |
| [GTM AI maturity](https://github.com/weilun88313/B2B-Playbook/blob/main/templates/gtm-ai-maturity.xlsx) | Sheet | Score each motion 0–4; climb one rung on a channel that already works | [GTM AI maturity](playbooks/09-operations-pipeline-and-measurement/gtm-ai-maturity.md) |
| [AI use-case score](https://github.com/weilun88313/B2B-Playbook/blob/main/templates/ai-use-case-score.xlsx) | Sheet | Rank problems by payoff, probability, and org load—not by demo | [AI use-case selection](playbooks/09-operations-pipeline-and-measurement/ai-use-case-selection.md) |
...
| [Contact data](https://github.com/weilun88313/B2B-Playbook/blob/main/templates/contact-data.xlsx) | Sheet | Test coverage, valid line, and right-person on *your* slice | [Contact data](playbooks/05-outbound-and-prospecting/contact-data.md) |
...
| [ABM system card](templates/abm-strategy.md) | Doc | Capacity, tiers, and what T3 is not allowed to be | [ABM strategy](playbooks/06-account-field-and-partner/abm-strategy.md) |
| [Expansion card](templates/expansion-marketing.md) | Doc | Realization gate, triggers, one next job | [Expansion marketing](playbooks/08-lifecycle-and-customer-marketing/expansion-marketing.md) |
| [Renewal card](templates/renewal-marketing.md) | Doc | Horizon clock and value packet before commercial | [Renewal marketing](playbooks/08-lifecycle-and-customer-marketing/renewal-marketing.md) |
| [White-paper brief](templates/white-paper.md) | Doc | One sourced claim; gate off unless the exchange is worth it | [White paper](playbooks/03-brand-story-and-content/white-paper.md) |
| [Review-site card](templates/review-sites.md) | Doc | Ask after value; do not draft their review | [Review sites](playbooks/04-channels-and-distribution/review-sites.md) |
| [Interaction card](templates/forms-and-chat.md) | Doc | Job first; chat is not a second demo queue | [Forms and chat](playbooks/07-website-and-conversion/forms-and-chat.md) |
