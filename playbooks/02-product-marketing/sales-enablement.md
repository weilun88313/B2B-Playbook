...
Do not walk two overlapping feature sets as if the overlap were the story. The story is why this **approach** wins for this buyer.

### Step 4: steal the shape, not the script

Two public patterns (April Dunford’s illustrations, not scripts to recite):

**Help Scout, as told in that source.** Insight: customer service is a growth function, not a cost center. Approaches: a shared inbox (easy; breaks when you need reporting and scale) versus a traditional help desk (powerful; painful for the people who have to live in it). Perfect world: easy enough that the team will actually use it, advanced enough to run the operation, designed around the customer’s experience. Follow-through demos those three requirements—not every ticket field.

**Postman, as told in that source.** Insight: APIs are how modern applications talk to each other; a bad API is a customer-experience and revenue risk, not an engineering hobby. Approaches: a pile of siloed tools for design, mock, test, and docs. Perfect world: one API-first lifecycle the team can run together. Follow-through shows integration, collaboration, and collections—not a catalog of buttons.

Write your own insight until a competitor could not open with the same sentence. Then list the approaches **your** deals actually contain, including doing nothing.

### Step 5: build it with the same room that built positioning
...
- Copying another company’s insight (growth-not-cost-center, API-first) because the structure was good.

## What to read next

If the champion leaves the meeting sold and still cannot explain the choice internally, they need [content](../03-brand-story-and-content/content-strategy.md)—pages that carry the same insight. If homepage, outbound, and this opener disagree, go back to [messaging](messaging.md). If they agreed the perfect world, the product walk is [demo](demo.md)—not a tour before agreement. If the category is crowded and value is “nothing happened,” qualify the fix in [change friction](change-friction.md). If they agree and have never been asked to pay, that is [pricing](pricing-and-packaging.md). If you do not yet know whether anyone would be angry if the product vanished, back up to [product-market fit](../01-strategy-and-buyers/product-market-fit.md). If someone else will carry a quota on those meetings, their pay plan is [sales compensation](../09-operations-pipeline-and-measurement/sales-compensation.md)—not a slide in the pitch.
