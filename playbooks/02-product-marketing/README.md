...
| [Product launch](product-launch.md) | Published | How should a product change become a coordinated market event—and when should it not? |
...
7. Right-size a [product launch](product-launch.md) as a campaign (tier, GACCS, after day one)—not every ship date.
8. Package remaining assets for website, content, partners, and lifecycle.
