...
- [Operations, pipeline & measurement](../09-operations-pipeline-and-measurement/) governs campaign data, attribution boundaries, [experiments](../09-operations-pipeline-and-measurement/experimentation.md), budget, and reporting. Search and answer visibility lives in [SEO and AEO](seo-and-aeo.md).
