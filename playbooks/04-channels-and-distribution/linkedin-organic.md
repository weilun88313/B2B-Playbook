...
| Field | Fill |
|---|---|
| Speaker | Founder, weekly. Not the brand account as the voice. |
| Perception | “Shared inbox breaks when someone is paid on queue health.” |
| 95% post | A scene from last week’s calls; product name optional |
| 5% path | Last line or comment: comparison URL, not a demo calendar |
| Company page | Reshare + one dated proof. No parallel slogan. |
| Will not do | “Comment ‘DEMO’,” engagement pods, scraping who liked a post into Outreach |

## Copy: LinkedIn organic card (fill)

- Named speaker and the perception they own:
- Why a stranger would forward this without buying us:
- Decision page this eventually serves (or “none—memory only”):
- Company-page job (library / jobs / proof)—not a second voice:
- What we will not put in line one (demo, discount, “we’re excited”):
- How we will know it worked (HDYHAU / sales mention)—not impressions:
- Stop rule:
...
|---|---|
| Champion forwards | Screenshots or “a colleague sent this” in deals or HDYHAU |
| Sales mentions | First meetings that cite the person, not the ad account |
...
- Company page as the only actor.
- Every post ends in a demo calendar.
- Hiring an algorithm coach before a point of view.
- Employee advocacy without a brief.
- Calling this outbound and connecting after every like.
- Declaring organic “dead” because last-touch software showed Direct.
