...
| Word | Meaning here |
|---|---|
| **Pipe-gen meeting** | Asks: *what will be in the pipeline?* Coverage, create plan, sources, next-quarter shape |
| **Forecast meeting** | Asks: *how much will close this period?* Categories, call, slips, reasons |
...
- **Deal coaching** is few deals, deep. A methodology checklist can live here as *questions on the record*, not as a 20-minute lecture. The [account plan](../06-account-field-and-partner/account-planning.md) and the [pitch](../02-product-marketing/sales-enablement.md) are the work; the meeting is the inspection.
...
| Slot | Fill |
|---|---|
| Forecast | Monday 25 min. Call + slips + reasons. No “also let’s talk outbound.” |
