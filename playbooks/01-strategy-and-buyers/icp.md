...
Choose one account and collect only verifiable information:
...
- **T3:** 0–3, insufficient evidence, or any hard disqualifier.
...
| T2 | Test one shared trigger hypothesis across a small segment |
...
Examples include no purchasing function, an unsupported contracting model, no budget owner, an out-of-scope use case, or a market the company cannot serve. Exclusions immediately remove accounts from the list; attractive adjectives do not.

### Step 2: define four observable filters

1. Industry and business job
2. Operating scale and ability to buy
3. Current-quarter trigger
...
- Unknowns:
- Default next action:
- Reason not to pursue, if T3:

## Completion checklist

- [ ] The ICP names a business job, not a product category.
- [ ] Operating scale can be observed or verified.
...
|---|---|---|
| T1 share | T1 accounts in active outbound / all active outbound accounts | A low share means personalized effort is being wasted |
| Disqualifier hit rate | Accounts removed by rules / new accounts reviewed | A rule that removes nothing is probably not operating |
| Committee completeness | T1 opportunities with a named economic buyer or blocker / all T1 opportunities | Champion-only pipelines are inflated |
