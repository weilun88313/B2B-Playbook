...
Buying organization and exclusion rules:
Current task, alternative and spending:
Evidence: claim / source / date / population / limitation
Conflicting observation:
Reachable count and assumptions:
Smallest next test, owner and cost ceiling:
Proceed / narrow / defer, with reason:
```
