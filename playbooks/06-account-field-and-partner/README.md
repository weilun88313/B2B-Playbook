...
- [ABM strategy](abm-strategy.md) — choose the accounts.
- [Event marketing](event-marketing.md) — choose the right event.
- [Ecosystem](ecosystem.md) — value for the customer.

## Playbook map

| Guide | What it helps you do |
|---|---|
| [Event marketing](event-marketing.md) | How should an event support a defined account, relationship, and pipeline objective? |
| [Trade shows](trade-shows.md) | How should a team select, prepare for, execute, and follow up on a trade show? |
| [Executive dinners](executive-dinners.md) | How can a small, role-locked table create a relationship and a next step? |
| [Ecosystem](ecosystem.md) | How should the company grow through partners who already have access and trust? |
| [Account planning](account-planning.md) | What is going on in this named account, and what will we do in 30/60/90 days? |
| [ABM strategy](abm-strategy.md) | Which accounts, tiers, and resources define the system—what is not ABM, and how account-driven GTM loads the TAM first? |
...
| Partner marketing | How should two companies create and capture shared demand inside the [ecosystem](ecosystem.md) flywheel? |
