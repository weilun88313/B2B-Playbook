...
![Capture (short clock); Creation (long clock); Evidence](../assets/illustrations/worksheet-measurement-model.svg)
...
- Board metrics a channel dashboard may not impersonate:

## Disagreement

- What we fund when SRA and software fight:
