...
1. Open the matching playbook first. It explains the inputs and the decision the file supports.
...
Find the available downloads in the [working-files catalog](../TEMPLATES.md). Edit your private copy to fit your team and keep the original download available if you need to start again.
