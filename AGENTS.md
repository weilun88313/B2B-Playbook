...
- Logo selected by Ivan on 2026-09-06: concept C, the continuous route symbol with an open right-hand exit. Use the shared traced silhouette across the light/dark wordmarks and favicon; the wordmark is outlined for consistent rendering. Do not restore the previous book icon or substitute concepts A/B.
